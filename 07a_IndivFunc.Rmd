...
indiv.phage <- hmm.indiv %>%
  group_by(aux, COG.broad, deets, xtremedeets, phrog_category, nogname, Nog.abbrev, comp, Genus, Sequencing.ID, phage_seq, BD.Inhibition, intact_est2) %>%
...
indiv.iso <- hmm.indiv %>%
  group_by(aux, COG.broad, deets, xtremedeets, phrog_category, nogname, Nog.abbrev, comp, Genus, Sequencing.ID, BD.Inhibition, intact_est2) %>%
  summarise(new.freq = sum(tally))
